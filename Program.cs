namespace Assignment_1_Asp_Net
{
    internal class Program
    {
        public static void Main()
        {
            ...
            // Reading the user's input and convert it to an integer
            ...
            // Reading the user's input and store it in the 'firstName' variable
            string firstName = Console.ReadLine();

            // Prompting the user to enter the last name of the patient
            Console.Write("Last Name of the patient : ");
            // Reading the user's input and store it in the 'lastName' variable
            ...
            // Reading the user's input and convert it to a double
            ...
            // Retrieving and display the patient's information using the 'GetPatientInformation' method
